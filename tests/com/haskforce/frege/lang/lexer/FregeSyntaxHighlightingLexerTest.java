 ...
 */
public class FregeSyntaxHighlightingLexerTest extends FregeLexerTestBase {
  @NotNull @Override protected String getExpectedPath() { return "highlighter"; }
  @Override protected Lexer createLexer() { return new FregeSyntaxHighlightingLexer(); }
